...
800002e4:	5e00006f          	j	800008c4 <USERRET_MACHINE>
...
80000300:	5b80006f          	j	800008b8 <USERRET_TIMEOUT>
...
800005c8:	807f02b7          	lui	t0,0x807f0
...
8000067c:	00f00293          	li	t0,15
80000680:	3a029073          	csrw	pmpcfg0,t0
80000684:	fff00293          	li	t0,-1
80000688:	3b029073          	csrw	pmpaddr0,t0
8000068c:	0040006f          	j	80000690 <WELCOME>

80000690 <WELCOME>:
80000690:	00001517          	auipc	a0,0x1
80000694:	ae050513          	addi	a0,a0,-1312 # 80001170 <monitor_version>
80000698:	9f9ff0ef          	jal	ra,80000090 <WRITE_SERIAL_STRING>
8000069c:	0040006f          	j	800006a0 <SHELL>

800006a0 <SHELL>:
800006a0:	a11ff0ef          	jal	ra,800000b0 <READ_SERIAL>
800006a4:	05200293          	li	t0,82
800006a8:	06550863          	beq	a0,t0,80000718 <.OP_R>
800006ac:	04400293          	li	t0,68
800006b0:	0a550263          	beq	a0,t0,80000754 <.OP_D>
800006b4:	04100293          	li	t0,65
800006b8:	0c550e63          	beq	a0,t0,80000794 <.OP_A>
800006bc:	04700293          	li	t0,71
800006c0:	10550c63          	beq	a0,t0,800007d8 <.OP_G>
800006c4:	05400293          	li	t0,84
800006c8:	00550863          	beq	a0,t0,800006d8 <.OP_T>
800006cc:	00400513          	li	a0,4
800006d0:	93dff0ef          	jal	ra,8000000c <WRITE_SERIAL>
800006d4:	2cc0006f          	j	800009a0 <.DONE>

800006d8 <.OP_T>:
800006d8:	ff410113          	addi	sp,sp,-12
800006dc:	00912023          	sw	s1,0(sp)
800006e0:	01212223          	sw	s2,4(sp)
800006e4:	fff00493          	li	s1,-1
800006e8:	00912423          	sw	s1,8(sp)
800006ec:	00810493          	addi	s1,sp,8
800006f0:	00400913          	li	s2,4
800006f4:	00048503          	lb	a0,0(s1)
800006f8:	fff90913          	addi	s2,s2,-1
800006fc:	911ff0ef          	jal	ra,8000000c <WRITE_SERIAL>
80000700:	00148493          	addi	s1,s1,1
80000704:	fe0918e3          	bnez	s2,800006f4 <.OP_T+0x1c>
80000708:	00012483          	lw	s1,0(sp)
8000070c:	00412903          	lw	s2,4(sp)
80000710:	00c10113          	addi	sp,sp,12
80000714:	28c0006f          	j	800009a0 <.DONE>

80000718 <.OP_R>:
80000718:	ff810113          	addi	sp,sp,-8
8000071c:	00912023          	sw	s1,0(sp)
80000720:	01212223          	sw	s2,4(sp)
80000724:	007f0497          	auipc	s1,0x7f0
80000728:	8dc48493          	addi	s1,s1,-1828 # 807f0000 <_sbss>
8000072c:	07c00913          	li	s2,124
80000730:	00048503          	lb	a0,0(s1)
80000734:	fff90913          	addi	s2,s2,-1
80000738:	8d5ff0ef          	jal	ra,8000000c <WRITE_SERIAL>
8000073c:	00148493          	addi	s1,s1,1
80000740:	fe0918e3          	bnez	s2,80000730 <.OP_R+0x18>
80000744:	00012483          	lw	s1,0(sp)
80000748:	00412903          	lw	s2,4(sp)
8000074c:	00810113          	addi	sp,sp,8
80000750:	2500006f          	j	800009a0 <.DONE>

80000754 <.OP_D>:
80000754:	ff810113          	addi	sp,sp,-8
80000758:	00912023          	sw	s1,0(sp)
8000075c:	01212223          	sw	s2,4(sp)
80000760:	9edff0ef          	jal	ra,8000014c <READ_SERIAL_XLEN>
80000764:	000564b3          	or	s1,a0,zero
80000768:	9e5ff0ef          	jal	ra,8000014c <READ_SERIAL_XLEN>
8000076c:	00056933          	or	s2,a0,zero
80000770:	00048503          	lb	a0,0(s1)
80000774:	fff90913          	addi	s2,s2,-1
80000778:	895ff0ef          	jal	ra,8000000c <WRITE_SERIAL>
8000077c:	00148493          	addi	s1,s1,1
80000780:	fe0918e3          	bnez	s2,80000770 <.OP_D+0x1c>
80000784:	00012483          	lw	s1,0(sp)
80000788:	00412903          	lw	s2,4(sp)
8000078c:	00810113          	addi	sp,sp,8
80000790:	2100006f          	j	800009a0 <.DONE>

80000794 <.OP_A>:
80000794:	ff810113          	addi	sp,sp,-8
80000798:	00912023          	sw	s1,0(sp)
8000079c:	01212223          	sw	s2,4(sp)
800007a0:	9adff0ef          	jal	ra,8000014c <READ_SERIAL_XLEN>
800007a4:	000564b3          	or	s1,a0,zero
800007a8:	9a5ff0ef          	jal	ra,8000014c <READ_SERIAL_XLEN>
800007ac:	00056933          	or	s2,a0,zero
800007b0:	00295913          	srli	s2,s2,0x2
800007b4:	919ff0ef          	jal	ra,800000cc <READ_SERIAL_WORD>
800007b8:	00a4a023          	sw	a0,0(s1)
800007bc:	fff90913          	addi	s2,s2,-1
800007c0:	00448493          	addi	s1,s1,4
800007c4:	fe0918e3          	bnez	s2,800007b4 <.OP_A+0x20>
800007c8:	00012483          	lw	s1,0(sp)
800007cc:	00412903          	lw	s2,4(sp)
800007d0:	00810113          	addi	sp,sp,8
800007d4:	1cc0006f          	j	800009a0 <.DONE>

800007d8 <.OP_G>:
800007d8:	975ff0ef          	jal	ra,8000014c <READ_SERIAL_XLEN>
800007dc:	00050d13          	mv	s10,a0
800007e0:	00600513          	li	a0,6
800007e4:	829ff0ef          	jal	ra,8000000c <WRITE_SERIAL>
800007e8:	341d1073          	csrw	mepc,s10
800007ec:	00002537          	lui	a0,0x2
800007f0:	80050513          	addi	a0,a0,-2048 # 1800 <INITLOCATE-0x7fffe800>
800007f4:	30053073          	csrc	mstatus,a0
800007f8:	0200c2b7          	lui	t0,0x200c
800007fc:	ff828293          	addi	t0,t0,-8 # 200bff8 <INITLOCATE-0x7dff4008>
80000800:	0002a303          	lw	t1,0(t0)
80000804:	0042a383          	lw	t2,4(t0)
80000808:	00989e37          	lui	t3,0x989
8000080c:	680e0e13          	addi	t3,t3,1664 # 989680 <INITLOCATE-0x7f676980>
80000810:	01c30e33          	add	t3,t1,t3
80000814:	006e3333          	sltu	t1,t3,t1
80000818:	006383b3          	add	t2,t2,t1
8000081c:	020042b7          	lui	t0,0x2004
80000820:	0072a223          	sw	t2,4(t0) # 2004004 <INITLOCATE-0x7dffbffc>
80000824:	01c2a023          	sw	t3,0(t0)
80000828:	007ef097          	auipc	ra,0x7ef
8000082c:	7d808093          	addi	ra,ra,2008 # 807f0000 <_sbss>
80000830:	0820a023          	sw	sp,128(ra)
80000834:	0040a103          	lw	sp,4(ra)
80000838:	0080a183          	lw	gp,8(ra)
8000083c:	00c0a203          	lw	tp,12(ra)
80000840:	0100a283          	lw	t0,16(ra)
80000844:	0140a303          	lw	t1,20(ra)
80000848:	0180a383          	lw	t2,24(ra)
8000084c:	01c0a403          	lw	s0,28(ra)
80000850:	0200a483          	lw	s1,32(ra)
80000854:	0240a503          	lw	a0,36(ra)
80000858:	0280a583          	lw	a1,40(ra)
8000085c:	02c0a603          	lw	a2,44(ra)
80000860:	0300a683          	lw	a3,48(ra)
80000864:	0340a703          	lw	a4,52(ra)
80000868:	0380a783          	lw	a5,56(ra)
8000086c:	03c0a803          	lw	a6,60(ra)
80000870:	0400a883          	lw	a7,64(ra)
80000874:	0440a903          	lw	s2,68(ra)
80000878:	0480a983          	lw	s3,72(ra)
8000087c:	04c0aa03          	lw	s4,76(ra)
80000880:	0500aa83          	lw	s5,80(ra)
80000884:	0540ab03          	lw	s6,84(ra)
80000888:	0580ab83          	lw	s7,88(ra)
8000088c:	05c0ac03          	lw	s8,92(ra)
80000890:	0600ac83          	lw	s9,96(ra)
80000894:	0680ad83          	lw	s11,104(ra)
80000898:	06c0ae03          	lw	t3,108(ra)
8000089c:	0700ae83          	lw	t4,112(ra)
800008a0:	0740af03          	lw	t5,116(ra)
800008a4:	0780af83          	lw	t6,120(ra)

800008a8 <.ENTER_UESR>:
800008a8:	00000097          	auipc	ra,0x0
800008ac:	00c08093          	addi	ra,ra,12 # 800008b4 <.USERRET_USER>
800008b0:	30200073          	mret

800008b4 <.USERRET_USER>:
800008b4:	00100073          	ebreak

800008b8 <USERRET_TIMEOUT>:
800008b8:	08100513          	li	a0,129
800008bc:	f50ff0ef          	jal	ra,8000000c <WRITE_SERIAL>
800008c0:	00c0006f          	j	800008cc <USERRET_MACHINE+0x8>

800008c4 <USERRET_MACHINE>:
800008c4:	00700513          	li	a0,7
800008c8:	f44ff0ef          	jal	ra,8000000c <WRITE_SERIAL>
800008cc:	007ef497          	auipc	s1,0x7ef
800008d0:	73448493          	addi	s1,s1,1844 # 807f0000 <_sbss>
800008d4:	08000913          	li	s2,128
800008d8:	00012503          	lw	a0,0(sp)
800008dc:	00a4a023          	sw	a0,0(s1)
800008e0:	ffc90913          	addi	s2,s2,-4
800008e4:	00448493          	addi	s1,s1,4
800008e8:	00410113          	addi	sp,sp,4
800008ec:	fe0916e3          	bnez	s2,800008d8 <USERRET_MACHINE+0x14>
800008f0:	007ef497          	auipc	s1,0x7ef
800008f4:	71048493          	addi	s1,s1,1808 # 807f0000 <_sbss>
800008f8:	0804a103          	lw	sp,128(s1)
800008fc:	0a40006f          	j	800009a0 <.DONE>

80000900 <.USERRET2>:
80000900:	007ef097          	auipc	ra,0x7ef
80000904:	70008093          	addi	ra,ra,1792 # 807f0000 <_sbss>
80000908:	0020a223          	sw	sp,4(ra)
8000090c:	0030a423          	sw	gp,8(ra)
80000910:	0040a623          	sw	tp,12(ra)
80000914:	0050a823          	sw	t0,16(ra)
80000918:	0060aa23          	sw	t1,20(ra)
8000091c:	0070ac23          	sw	t2,24(ra)
80000920:	0080ae23          	sw	s0,28(ra)
80000924:	0290a023          	sw	s1,32(ra)
80000928:	02a0a223          	sw	a0,36(ra)
8000092c:	02b0a423          	sw	a1,40(ra)
80000930:	02c0a623          	sw	a2,44(ra)
80000934:	02d0a823          	sw	a3,48(ra)
80000938:	02e0aa23          	sw	a4,52(ra)
8000093c:	02f0ac23          	sw	a5,56(ra)
80000940:	0300ae23          	sw	a6,60(ra)
80000944:	0510a023          	sw	a7,64(ra)
80000948:	0520a223          	sw	s2,68(ra)
8000094c:	0530a423          	sw	s3,72(ra)
80000950:	0540a623          	sw	s4,76(ra)
80000954:	0550a823          	sw	s5,80(ra)
80000958:	0560aa23          	sw	s6,84(ra)
8000095c:	0570ac23          	sw	s7,88(ra)
80000960:	0580ae23          	sw	s8,92(ra)
80000964:	0790a023          	sw	s9,96(ra)
80000968:	07a0a223          	sw	s10,100(ra)
8000096c:	07b0a423          	sw	s11,104(ra)
80000970:	07c0a623          	sw	t3,108(ra)
80000974:	07d0a823          	sw	t4,112(ra)
80000978:	07e0aa23          	sw	t5,116(ra)
8000097c:	07f0ac23          	sw	t6,120(ra)
80000980:	0800a103          	lw	sp,128(ra)
80000984:	00008513          	mv	a0,ra
80000988:	00000097          	auipc	ra,0x0
8000098c:	f7808093          	addi	ra,ra,-136 # 80000900 <.USERRET2>
80000990:	00152023          	sw	ra,0(a0)
80000994:	00700513          	li	a0,7
80000998:	e74ff0ef          	jal	ra,8000000c <WRITE_SERIAL>
8000099c:	0040006f          	j	800009a0 <.DONE>

800009a0 <.DONE>:
800009a0:	d01ff06f          	j	800006a0 <SHELL>
	...
